...
output_dir = '../data/dt_stock_results'
...
for file in cleaned_files:
    print(f"\nProcessing file (Decision Tree Stock): {file}")
    ...
    # Feature selection: top 15 using ANOVA F-test
    ...
    # Save results
    results_df.to_csv(os.path.join(output_dir, f"dt_stock_{file.replace('.csv', '')}_metrics.csv"), index=False)
