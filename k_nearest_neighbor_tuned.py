...
for file in cleaned_files:
    print(f"\nProcessing file (KNN Tuned, 40 features): {file}")
    ...
    # Encode class labels (e.g., 'BENIGN' -> 0, 'DDoS' -> 1, etc.)
    ...
    knn_model = KNeighborsClassifier(
        n_neighbors=3,            # Increased down to 3
        weights='distance',        # Trying uniform voting
    ...
    for attack_code in unique_attacks:
        ...
        attack_indices = (y_test == attack_code)
